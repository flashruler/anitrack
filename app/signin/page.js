  ...
  return (
    <div className="bg-[#0d1f2d] w-creen h-screen flex justify-center items-center">
      <div className="flex flex-col items-center justify-center">
        ...
        <h1 className="text-white text-2xl font-thin uppercase mt-3">
          Sign In
        </h1>
        <form onSubmit={handleForm} className="flex flex-col items-center">
          ...
          <button type="submit" className="bg-white w-24 my-3 rounded-sm">
            Sign In
          </button>
        </form>
        <Link
          className="text-white text-sm font-thin uppercase mt-3 italic"
          href="/signup"
        >
